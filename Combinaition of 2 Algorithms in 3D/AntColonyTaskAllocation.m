function [ best_ant_path, min_dist, travelled_time, Best_path] = AntColonyTaskAllocation(UAV_position,Target_position,UAV_number,UAV_speed,task_number,...
...
for i=1:iteratornum
    ...
    [best_ant_path, min_dist,travelled_time,Best_path]=find_best_ant_path(all_ant_path,UAV_number,task_number,...
