function [ best_ant_path] = AntColonyAlgorothm(UAV_position,Target_position,UAV_number,UAV_speed,task_number,...
...
for i=1:iteratornum
    ...
    [best_ant_path, min_dist(i)]=find_best_ant_path_realtime(all_ant_path,UAV_number,task_number,ant_num,UAV_position,Target_position,UAV_speed);
